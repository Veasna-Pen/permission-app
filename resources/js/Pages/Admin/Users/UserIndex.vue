                ...
                <div class="bg-white overflow-hidden sm:rounded-lg">
                    <div class="p-4 sm:px-4 bg-gray-100 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            <div>
                                <Link :href="route('users.create')" :active="route().current('users.index')"
                                ...
                                <select v-model="perPage" @change="getUsers" id="countries"
                            ...
                            <tbody>
                                <tr v-for="user in users.data" :key="user.id"
                                    ...
                                    <td class="flex py-4 px-6 space-x-3">
                                        <Link :href="route('users.edit', user.id)" class="hover:bg-purple-100">
                                        ...
                                        <Link :href="route('users.destroy', user.id)" class="hover:bg-red-100"
