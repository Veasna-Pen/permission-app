                ...
                <div class="bg-white overflow-hidden sm:rounded-lg">
                    <div class="p-4 sm:px-4 bg-gray-100 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            <div>
                                <Link :href="route('permissions.create')" :active="route().current('permissions.index')"
                                ...
                                <select v-model="perPage" @change="getPermissions" id="countries"
                            ...
                            <tbody>
                                <tr v-for="permission in permissions.data" :key="permission.id"
                                    ...
                                    <td class="flex py-4 px-6 space-x-3">
                                        <Link :href="route('permissions.edit', permission.id)" class="hover:bg-purple-100">
                                        ...
                                        <button @click="confirmDeletePermission" class="hover:bg-red-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                class="w-6 h-6">
                                                <path fill-rule="evenodd"
                                        ...
                                        <Modal :show="showConfirmDeletePermissionModal" @close="closeModal">
                                            <div class="p-6">
                                                ...
                                                <div class="mt-6 flex space-x-4">
                                                    <DangerButton @click="deletePermission(permission.id)">Delete
                                                    </DangerButton>
