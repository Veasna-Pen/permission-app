    ...
    <section id="hero" class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <blockquote class="text-6xl font-extrabold text-gray-900 dark:text-white">
                    <p>Learning to code is</p>
                </blockquote>

                <p class="max-w-2xl pt-2 mb-6 font-medium text-blue-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">like learning a new language,</p>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                    except instead of talking to people, you're talking to machines. 😁</p>
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="https://github.com/Veasna3d"
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="http://127.0.0.1:8000/assets/images/hero1.gif" alt="hero image">
            </div>
        </div>
</section></template>
