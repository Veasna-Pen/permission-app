<template>
    <header class="fixed w-full">
        <nav :class="{
            'bg-white border-2 border-b-indigo-500 rounded-b-lg py-2.5 dark:bg-gray-900': scrollBg,
            '': !scrollBg,
        }" class="border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <Link :href="route('home')" class="flex items-center">
                    <img src="http://127.0.0.1:8000/assets/images/logo.gif" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">I Stack</span>
                </Link>
